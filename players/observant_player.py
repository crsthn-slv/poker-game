"""
Jogador observador que analisa padrões.
...
def _create_config(memory_file: str = "observant_player_memory.json") -> BotConfig:
    """Cria configuração para jogador observador que analisa padrões."""
    return BotConfig(
        # Identificação do bot
        name="Observant",  # Nome do bot (string)
...
class ObservantPlayer(PokerBotBase):
    """Jogador observador que analisa padrões."""
