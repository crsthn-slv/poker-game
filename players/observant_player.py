...
class ObservantPlayer(BasePokerPlayer):
    ...
    def declare_action(self, valid_actions, hole_card, round_state):
        ...
        if should_bluff:
            ...
            action, amount = self._normal_action(valid_actions, hand_strength, round_state, active_opponents, current_actions, bluff_analysis)
    ...
    def _normal_action(self, valid_actions, hand_strength, round_state, active_opponents, current_actions=None, bluff_analysis=None):
        ...
        if hand_strength >= adjusted_threshold:
            ...
            if adjusted_aggression > 0.51 and valid_actions[2]['amount']['min'] != -1:
                return valid_actions[2]['action'], valid_actions[2]['amount']['min']
            else:
                call_action = valid_actions[1]
                return call_action['action'], call_action['amount']
        ...
        if bluff_analysis and bluff_analysis['should_call_bluff']:
            if hand_strength >= 26:  # Observant: paga blefe com mão razoável
                call_action = valid_actions[1]
                return call_action['action'], call_action['amount']
