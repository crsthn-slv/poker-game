...
def _create_config(memory_file: str = "steady_aggressive_player_memory.json") -> BotConfig:
    """Cria configuração para jogador agressivo estável."""
    return BotConfig(
        # Identificação do bot
        name="SteadyAggressive",  # Nome do bot (string)
        ...
        bluff_raise_prob_few_players=0.7,
        ...
        raise_threshold_adjustment_base=4,
...
class SteadyAggressivePlayer(PokerBotBase):
    """Jogador agressivo estável."""
