"""
Jogador pensativo que analisa profundamente.
...
def _create_config(memory_file: str = "thoughtful_player_memory.json") -> BotConfig:
    """Cria configuração para jogador pensativo que analisa profundamente."""
    return BotConfig(
        # Identificação do bot
        name="Thoughtful",  # Nome do bot (string)
...
class ThoughtfulPlayer(PokerBotBase):
    """Jogador pensativo que analisa profundamente."""
