"""
Jogador cauteloso - configuração e instanciação.
...
def _create_config(memory_file: str = "cautious_player_memory.json") -> BotConfig:
    """Cria configuração para jogador cauteloso"""
    return BotConfig(
        # Identificação do bot
        name="Cautious",  # Nome do bot (string)
        ...
        # 0.30 = 30% chance de call, 70% chance de raise no blefe
        bluff_call_ratio=0.30,
        ...
        bluff_raise_prob_few_players=0.30,
        ...
        bluff_raise_prob_many_players=0.30,
        ...
        passive_raise_score_threshold=0.7,
...
class CautiousPlayer(PokerBotBase):
    """Jogador cauteloso que prefere segurança, mas não é extremamente conservador."""
