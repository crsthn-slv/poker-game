"""
Jogador flexível que se adapta ao contexto.
...
def _create_config(memory_file: str = "flexible_player_memory.json") -> BotConfig:
    """Cria configuração para jogador flexível que se adapta ao contexto."""
    return BotConfig(
        # Identificação do bot
        name="Flexible",  # Nome do bot (string)
...
class FlexiblePlayer(PokerBotBase):
    """Jogador flexível que se adapta ao contexto."""
