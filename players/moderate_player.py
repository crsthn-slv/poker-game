"""
Jogador moderado com estratégia equilibrada.
...
def _create_config(memory_file: str = "moderate_player_memory.json") -> BotConfig:
    """Cria configuração para jogador moderado com estratégia equilibrada."""
    return BotConfig(
        # Identificação do bot
        name="Moderate",  # Nome do bot (string)
...
class ModeratePlayer(PokerBotBase):
    """Jogador moderado com estratégia equilibrada."""
