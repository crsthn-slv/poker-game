"""
Jogador aleatório com decisões estocásticas.
...
def _create_config(memory_file: str = "random_player_memory.json") -> BotConfig:
    """Cria configuração para jogador aleatório com decisões estocásticas."""
    return BotConfig(
        # Identificação do bot
        name="Random",  # Nome do bot (string)
...
class RandomPlayer(PokerBotBase):
    """Jogador aleatório com decisões estocásticas."""
