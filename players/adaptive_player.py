"""
Jogador adaptativo que combina análise e exploração.
...
def _create_config(memory_file: str = "adaptive_player_memory.json") -> BotConfig:
    """Cria configuração para jogador adaptativo que combina análise e exploração."""
    return BotConfig(
        # Identificação do bot
        name="Adaptive",  # Nome do bot (string)
...
class AdaptivePlayer(PokerBotBase):
    """Jogador adaptativo que combina análise e exploração."""
