"""
Jogador calculado que analisa cuidadosamente cada decisão.
...
def _create_config(memory_file: str = "calculated_player_memory.json") -> BotConfig:
    """Cria configuração para jogador calculado que analisa cuidadosamente cada decisão."""
    return BotConfig(
        # Identificação do bot
        name="Calculated",  # Nome do bot (string)
...
class CalculatedPlayer(PokerBotBase):
    """Jogador calculado que analisa cuidadosamente cada decisão."""
