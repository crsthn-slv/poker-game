...
def _create_config(memory_file: str = "calm_player_memory.json") -> BotConfig:
    """Cria configuração para jogador calmo e sereno."""
    return BotConfig(
        # Identificação do bot
        name="Calm",  # Nome do bot (string)
