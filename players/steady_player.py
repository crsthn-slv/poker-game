...
def _create_config(memory_file: str = "steady_player_memory.json") -> BotConfig:
    """Cria configuração para jogador estável e consistente."""
    return BotConfig(
        # Identificação do bot
        name="Steady",  # Nome do bot (string)
...
class SteadyPlayer(PokerBotBase):
    """Jogador estável e consistente."""
