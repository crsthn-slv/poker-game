"""
Jogador peixe (iniciante) que aprende lentamente.
...
def _create_config(memory_file: str = "fish_player_memory.json") -> BotConfig:
    """Cria configuração para jogador peixe (iniciante) que aprende lentamente."""
    return BotConfig(
        # Identificação do bot
        name="Fish",  # Nome do bot (string)
        ...
        bluff_raise_prob_many_players=0.3,
        # ============================================================
        ...
        passive_raise_score_threshold=0.5,
        # ============================================================
