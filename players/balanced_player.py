"""
Jogador balanceado - configuração e instanciação.
...
def _create_config(memory_file: str = "balanced_player_memory.json") -> BotConfig:
    """Cria configuração para jogador balanceado"""
    return BotConfig(
        # Identificação do bot
        name="Balanced",  # Nome do bot (string)
        ...
        # 0.50 = 50% chance de call, 50% chance de raise no blefe
...
class BalancedPlayer(PokerBotBase):
